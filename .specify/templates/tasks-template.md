...
**Tests**: Behavior changes require explicit verification tasks. Prefer automated
tests for business rules, API contracts, persistence, and UI flows. If automated
tests are not used for a behavior, include a task documenting the verification
...
- **TaskFlow SDD web app**: `backend/src/Api/`, `backend/src/Application/`,
  `backend/src/Domain/`, `backend/src/Infrastructure/`, `backend/tests/`,
...
- [ ] T004 Confirm no implementation starts before spec.md, plan.md, and tasks.md are complete
...
tasks in the initial MVP unless a later approved spec explicitly changes scope.
...
Task: "Contract/API test for [endpoint] in [test path]"
Task: "Integration or UI verification for [user journey] in [test path]"

# Launch all models for User Story 1 together:
Task: "Create [Entity1] model in [domain path]"
Task: "Create [Entity2] model in [domain path]"
```
